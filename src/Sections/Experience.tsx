...
export default function Experience() {
  return (
    <section id="experience" className="bg-white py-20 px-6">
      <h2 className="text-3xl font-bold text-center text-purple-700 mb-12">Experience</h2>
      <div className="max-w-4xl mx-auto relative border-l-2 border-purple-300 pl-6">
        {experiences.map((item, index) => (
          <div key={index} className="mb-12 relative">
            {/* Timeline Dot */}
            <div className="absolute -left-[35px] top-1 w-5 h-5 bg-purple-500 rounded-full border-4 border-white shadow" />
