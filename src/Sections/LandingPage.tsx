...
export default function LandingPage() {
  ...
  return (
    <section className="min-h-screen flex flex-col justify-center items-center text-center px-4 bg-gradient-to-b from-purple-50 to-white">
      <h1 className="text-5xl font-bold text-[#01796F] mb-4">Shreya Chauhan</h1>
      <p className="text-lg text-gray-600 mb-8 max-w-xl">
        Data Analytics Professional | MS in Information Systems
      </p>
      <button
        onClick={() => navigate('/portfolio')}
        className="bg-[#01796F] hover:bg-[#01796F] text-white font-medium px-6 py-3 rounded-full transition"
      >
        View Portfolio
      </button>
    </section>
